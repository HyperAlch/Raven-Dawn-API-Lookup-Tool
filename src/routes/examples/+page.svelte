...
<header>
	<hgroup>
		...
		<p>Just a pure semantic HTML markup, without <code>.classes</code></p>
	</hgroup>
	<nav>
		<ul>
			<li>
				<details role="list">
					...
					<ul role="listbox">
						<li><a href="/examples" data-theme-switcher="auto">Auto</a></li>
						<li><a href="/examples" data-theme-switcher="light">Light</a></li>
						<li><a href="/examples" data-theme-switcher="dark">Dark</a></li>
					</ul>
				</details>
			</li>
		</ul>
		...
		<form>
			...
			<fieldset>
				<label for="terms">
					...
					I agree to the <a href="/examples" on:click|preventDefault>Privacy Policy</a>
				</label>
			</fieldset>
	...
	<section id="typography">
		...
		<figure>
			<table>
				<tbody>
					<tr>
						<td><a href="/examples" on:click|preventDefault>Link</a></td>
		...
		<p>
			...
			consequat luctus. Morbi euismod sagittis efficitur. Aenean non eros orci. Vivamus ut diam sem.
		</p>
		<h6>Heading 6</h6>
		<p>
		...
		<figure>
			<img
				src="https://raw.githubusercontent.com/picocss/examples/master/v1-classless/img/aleksandar-jason-a562ZEFKW8I-unsplash-2000x1000.jpg"
	...
	<section id="accordions">
		...
		<details>
			...
			<p>
				...
				commodo. Nulla non mauris ipsum. Aliquam eu posuere orci. Nulla convallis lectus rutrum quam
				hendrerit, in facilisis elit sollicitudin. Mauris pulvinar pulvinar mi, dictum tristique
				elit auctor quis. Maecenas ac ipsum ultrices, porta turpis sit amet, congue turpis.
			</p>
		</details>
		<details open>
...
<footer>
	<small
		...
		<a href="https://github.com/picocss/examples/blob/master/v1-classless/index.html">Source code</a
		></small
	>
</footer>
